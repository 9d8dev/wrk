...
export function usePostHogEvents() {
  ...
  const trackPortfolioView = useCallback((username: string, domainType: 'main' | 'subdomain' | 'custom') => {
  ...
  const trackProjectView = useCallback((projectSlug: string, portfolioOwner: string) => {
  ...
  const trackContactFormSubmission = useCallback((portfolioOwner: string, success: boolean) => {
  ...
  const trackProjectUpdated = useCallback((projectId: string) => {
  ...
  const trackThemeChanged = useCallback((newTheme: string) => {
  ...
  const trackCustomDomainAdded = useCallback((domain: string) => {
  ...
  const trackCustomDomainVerified = useCallback((domain: string) => {
  ...
  const trackCustomDomainRemoved = useCallback((domain: string) => {
  ...
  const trackSignIn = useCallback((method: 'email' | 'google' | 'github') => {
