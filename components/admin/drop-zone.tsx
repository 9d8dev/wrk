  ...
  return (
    <>
      <button
        ...
        type="button"
        className={cn(
          "relative w-full cursor-pointer rounded-md border-2 border-dashed transition-all",
          isDragging
      ...
      >
        ...
        <div
          className={cn(
            "bg-primary/5 absolute inset-0 z-10 flex items-center justify-center transition-opacity duration-200",
