...
async function checkDNSDiagnostics(domain: string): Promise<DiagnosticResult[]> {
...
async function checkVercelDiagnostics(domain: string): Promise<DiagnosticResult[]> {
  const results: DiagnosticResult[] = [];
...
async function checkHTTPDiagnostics(domain: string): Promise<DiagnosticResult[]> {
  const results: DiagnosticResult[] = [];
