...
function hasActivePro(userRecord: { subscriptionStatus: string | null }): boolean {
...
export async function POST(request: NextRequest) {
  try {
    ...
    return NextResponse.json({ 
      ...
      domain,
      status: 'pending',
      message: 'Domain added successfully. Please configure your DNS settings to complete verification.'
    });
